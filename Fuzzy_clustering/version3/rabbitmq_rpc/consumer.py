...
class MessageDispatcher(object):
    ...
    def reply_message(self, props, body, headers=None, is_error=False):
        ...
        while True:
            try:
                self._connection.add_callback_threadsafe(partial(self._channel.basic_publish,
    ...
    def acknowledge_message(self, delivery_tag):
        self._connection.add_callback_threadsafe(partial(self._channel.basic_ack, delivery_tag))
