...
class SKLearn_Manager(object):
    ...
    def fit(self):
        ...
        if self.istrained == False:
            cvs = self.load_data()
            model_sklearn = sklearn_model(self.static_data, self.sk_models_dir, self.rated, self.method, self.njobs, path_group=self.path_group)
    ...
    def fit_TL(self):
        ...
        model_sklearn_TL = sklearn_model(static_data_tl, cluster_dir_tl, static_data_tl['rated'], self.method, self.njobs)
        if self.istrained == False:
            cvs = self.load_data()
