...
from Fuzzy_clustering.version3.FeatureSelectionManager.Sklearn_models_optuna import sklearn_model
import copy
    ...
    def fit(self, cvs):
        ...
        while flag:
            for f in unchecked:
                ...
                reg_temp = sklearn_model(self.static_data, os.path.join(self.log_dir, 'temp'), 1, method, njobs, FS=True, path_group=self.path_group)
                for i in range(3):
