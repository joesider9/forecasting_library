...
from Fuzzy_clustering.version3.FeatureSelectionManager.Sklearn_models_deap import sklearn_model
...
class FS(object):
    def __init__(self, static_data, model_path, njobs, path_group=None):
