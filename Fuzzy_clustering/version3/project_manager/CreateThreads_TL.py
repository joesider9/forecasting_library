...
def train_stage_rbfols_TL(tasks_ols, njobs):
    results = Parallel(n_jobs=njobs)(
        delayed(RBFOLS_thread_TL)(task['project'], task['static_data'], task['cluster']) for task in tasks_ols)
...
def train_stage_sklearn_TL(tasks_sk, njobs):
    results = Parallel(n_jobs=njobs)(
        delayed(SKlearn_thread_TL)(task['project'], task['static_data'], task['cluster'], task['method'],
                                   task['optimize_method']) for task in tasks_sk)
