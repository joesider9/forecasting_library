...
if Docker:
    ...
    if sys.platform == 'linux':
        ...
        if user_name == 'timos':
            project_path = '/home/timos/Desktop/LoadForecasting/Data/'
            sys_folder = project_path
            nwp_folder = project_path
            data_file_name = f'{project_path}Petalas/data/wind_ts.csv'
        else:
...
compress_data = 'PCA'  # PCA or dense
...
project_methods = {'RBF_ALL_CNN': True, 'RBF_ALL': False, 'CNN': True, 'LSTM': False, 'MLP_3D': False, 'SVM': True,
                   'NUSVM': False, 'MLP': True, 'RF': True, 'XGB': False, 'elasticnet': False}
