...
if Docker:
    sys_folder = '/models/'
    nwp_folder = '/nwp_grib/'
    data_file_name = '/data/load_ts.csv'
else:
    if sys.platform == 'linux':
        sys_folder = '/media/smartrue/HHD1/George/models/'
        nwp_folder = '/media/smartrue/HHD2/'
        data_file_name = '/home/smartrue/PycharmProjects/Kythnos/data/load_ts.csv'
    else:
        sys_folder = 'D:/models/'
        nwp_folder = 'D:/Dropbox/'
        data_file_name = 'D:/Dropbox/current_codes/PycharmProjects/Kythnos/data/load_ts.csv'
...
tl_project = ''
feature_selection_method = 'linearsearch' #boruta or permutation, linearsearch
...
resampling_on_var = [['load',0], ['Temp',[4, 5, 6]]]   # NAME OF THE VARIABLES FOR RESAMPLING AND INDEX OF THE VARIABLES ON 3D DATA NOT NECESSARY FOR WIND AND PV
