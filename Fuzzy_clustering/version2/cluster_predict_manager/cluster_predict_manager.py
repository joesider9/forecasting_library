...
from Fuzzy_clustering.version2.cluster_predict_manager.combine_cluster_predict import ClusterCombiner
from Fuzzy_clustering.version2.cluster_predict_manager.deep_models import model3d
from Fuzzy_clustering.version2.cluster_predict_manager.fs_manager import FeatSelManager
from Fuzzy_clustering.version2.cluster_predict_manager.rbf_cnn_model import RBF_CNN_model
from Fuzzy_clustering.version2.cluster_predict_manager.sklearn_models import SKLearn_Model
...
class ClusterPredict():
    ...
    def spark_predict(self, X, X_cnn=np.array([]), X_lstm=np.array([]), fs_reduced=False):
        ...
        comb_model = ClusterCombiner(self.static_data, self.cluster)
