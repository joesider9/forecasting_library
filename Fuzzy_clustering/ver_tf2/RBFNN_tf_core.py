...
class RBFNN():
    ...
    def __init__(self, path_model, rated=None, max_iterations=10000, learning_rate=5e-4,mean_var=0.05,std_var=0.05):
    ...
    def train(self, X_train, y_train, X_val, y_val, X_test, y_test,num_centr, lr, gpu_id='/cpu:0'):
                ...
                for i in tqdm(range(self.max_iterations)):
                    if i % 100 == 0:
                        ...
                        if flag:
                            ...
                            W = wi
                            res[str(i)]=obj_old
                            print("RBFNN accuracy : %s" % str(obj_old[0]/20))
                            best_iteration = i
                            wait = 0
                        else:
                            wait += 1
        ...
        print("Total accuracy RBFNN: %s" % str(obj_old[0]/20))
