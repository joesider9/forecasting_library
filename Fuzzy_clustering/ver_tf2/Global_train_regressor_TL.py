...
class global_train_tl(object):
    def __init__(self, static_data, x_scaler, gpu):
    ...
    def split_dataset(self, X, y, act, X_cnn=np.array([]), X_lstm=np.array([])):
        ...
        X_train, X_test1, y_train, y_test1, mask_test1 = split_continuous(X, y, test_size=0.15, random_state=42,
                                                                          mask=False)
